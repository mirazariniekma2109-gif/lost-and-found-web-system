...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 90vh; padding: 20px;">
    <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 15px; width: 850px; height: 550px; display: flex; flex-direction: row; background: white;">
        ...
        <div class="p-4 custom-scrollbar" style="width: 55%; overflow-y: auto; border-right: 1px solid #f1f5f9;">
            <div class="mb-3">
                <h4 class="fw-bold mb-1 text-dark" style="font-size: 1.2rem;">Report Found Item</h4>
                <p class="text-muted" style="font-size: 0.7rem;">Provide details of the item found.</p>
            </div>
            ...
            <form action="{{ route('found.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="item_name" value="{{ old('item_name') }}" class="form-control form-control-sm bg-light border-0" placeholder="Enter item name..." required style="font-size: 0.75rem; border-radius: 6px;">
                </div>

                <div class="row g-2 mb-3">
                    <div class="col-md-6">
                        <label class="form-label fw-bold text-dark mb-1" style="font-size: 0.7rem;">Category</label>
                        <select name="category" class="form-select form-select-sm bg-light border-0" style="font-size: 0.75rem; border-radius: 6px;">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-bold text-dark mb-1" style="font-size: 0.7rem;">Date Found</label>
                        <input type="date" name="date_found" value="{{ old('date_found') }}" class="form-control form-control-sm bg-light border-0" required style="font-size: 0.75rem; border-radius: 6px;">
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold text-dark mb-1" style="font-size: 0.7rem;">Found Location</label>
                    <input type="text" name="location_found" value="{{ old('location_found') }}" class="form-control form-control-sm bg-light border-0" placeholder="Where did you find it?" required style="font-size: 0.75rem; border-radius: 6px;">
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold text-dark mb-1" style="font-size: 0.7rem;">Description</label>
                    <textarea name="description" class="form-control bg-light border-0" rows="3" placeholder="Brief description..." style="font-size: 0.75rem; border-radius: 6px;">{{ old('description') }}</textarea>
                </div>
    ...
    <p class="mt-1 mb-0 text-muted" style="font-size: 0.65rem;">
        <i class="bi bi-info-circle me-1"></i> Highly recommended for electronic items for accurate verification purposes.
                ...
                <div class="mb-3">
    <label class="form-label fw-bold text-dark mb-1" style="font-size: 0.7rem;">Contact Number (WhatsApp)</label>
    <div class="input-group input-group-sm">
        <span class="input-group-text bg-light border-0" style="font-size: 0.75rem;">+60</span>
        <input type="text" name="finder_contact" value="{{ old('finder_contact') }}" 
               class="form-control bg-light border-0" 
               placeholder="123456789" required 
               style="font-size: 0.75rem; border-radius: 0 6px 6px 0;">
    </div>
    <small class="text-muted" style="font-size: 0.6rem;">Please provide a valid phone number for the owner to reach you.</small>
</div>
        ...
        <div style="width: 45%; background: #ffffff; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 30px;">
            <img src="{{ asset('images/rightside.jpeg') }}" alt="Found Illustration" style="width: 100%; max-width: 250px; height: auto; object-fit: contain;">
            <div class="mt-3 text-center px-3">
                <p class="text-muted" style="font-size: 0.7rem; line-height: 1.4;">
                    Describe the found item accurately to help the rightful owner identify it quickly.
                </p>
            </div>
        </div>
